...
const makeTourRequest = (tour) => {
  ...
  const deleteTourByUser = (id) => {  
    return axios.delete(`${API_URL}/tour/${id}/auth`, { headers: authHeader()});
  };

export { getUserTourRequestById, getUserTourRequests, makeTourRequest, deleteTourByUser };
